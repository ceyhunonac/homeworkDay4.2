...
public class QEMExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(QEMDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new QEMStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static QEMDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static QEMDateTimeConverter dateTimeConverter = new QEMStandardDateTimeConverter();

    public QEMExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public QEMExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new QEMMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=QEMHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,QEMExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=QEMHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
