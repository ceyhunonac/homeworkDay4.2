...
public class QEMKPSPublicSoap
{
    ...
    public QEMKPSPublicSoap(){}

    public QEMKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public QEMKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        QEMExtendedSoapSerializationEnvelope envelope= new QEMExtendedSoapSerializationEnvelope(QEMExtendedSoapSerializationEnvelope.VER11);
